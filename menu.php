					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href="#"><i class="fa fa-envelope"> </i>sidehustleinternship@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-md-4 clearfix">
						<div class="logo pull-left">
							<a href="default.php"><img src="images/home/logo.png" alt="" /></a>
					...
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="postitems.php"><i class="fa fa-shopping-cart"></i> Post Items</a></li>
								<?php
								if(user_login()){
								?>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							...
							<li><a href="default.php" class="active">Home</a></li>
								...
								?>
								<li><a href="postitems.php" class="active">Post Items</a></li>
								<?php
								if(!user_login()){
								?>
