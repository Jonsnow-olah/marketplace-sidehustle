						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									...
									<p>Buy products you neeed, and also sell products you don't need to people whom need it. </p>
									<a href="postitems.php"><button type="button" class="btn btn-default get">Sell Now!!</button></a>
								</div>
								<div class="col-sm-6">
							...
							<div class="item">
								<div class="col-sm-6">
									...
									<p>Connect with people by buying and selling to each other. </p>
									<a href="postitems.php"><button type="button" class="btn btn-default get">Connect Now!!</button></a>
								</div>
								<div class="col-sm-6">
							...
							<div class="item">
								<div class="col-sm-6">
									...
									<a href="postitems.php"><button type="button" class="btn btn-default get">Get it now</button></a>
								</div>
								<div class="col-sm-6">
